<?php
    ...
    if(p('name')!="" and p('email')!="" and p('subject')!="" and p('message')!=""){
        ...
        try {
            ...
            $mail->isSMTP(); 
            $mail->Host = gethostbyname('mail.ezgiyesilbas.com'); // SMTP sunucusu örnek : mail.alanadi.com
            $mail->SMTPAuth = true; // SMTP Doğrulama
            $mail->Username = 'info@ezgiyesilbas.com'; // Mail kullanıcı adı
            $mail->Password = 'Portfolioezgi'; // Mail şifresi
            ...
            $mail->addAddress('info@ezgiyesilbas.com');
