                            ...
                            <div class="col-xl-12 col-md-6">
                                <div class="card text-white mb-4">
                                        ...
                                        <table id="datatablesSimple1">
                                            ...
                                            <?php foreach ($testimonials as $testimonial){ ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="<?php echo base_url().'index.php/admin/testimonial/duzenle/'.$testimonial["Testimonials_Id"];?>">
                                                            <input class="btn btn-primary" type="submit" value="Düzenle">
                                                        </a>
                                                        <a href="<?php echo base_url().'index.php/admin/testimonial/sil/'.$testimonial["Testimonials_Id"];?>">
                                    ...
                                    <div class="card-footer bg-primary d-flex align-items-center justify-content-between">
                                        <a class="small text-white" href="<?php echo base_url().'index.php/admin/testimonial/ekle'?>">Yeni Ekle</a>
