                                ...
                                <div class="card text-white mb-4">
                                    ...
                                    <div class="card-body">
                                        <table id="datatablesSimple1">
                                            ...
                                            <tbody>
                                            <?php foreach ($slider as $portfolio){ ?>
                                                <tr>
                                                    <td><img style="width: 70%; margin-bottom: 2%;" src="<?php echo base_url().'assets/img/portfolio/portfolio'.$id.'/'.$portfolio["Portfolio_slider_img"];?>"/></td>
                                                    <td>
                                                        <a href="<?php echo base_url().'index.php/admin/portfolioslider/duzenle/'.$portfolio["Portfolio_Id"].'/'.$portfolio["Portfolio_slider_Id"];?>">
                                                            <input class="btn btn-primary" type="submit" value="Düzenle">
                                                        </a>
                                                        <a href="<?php echo base_url().'index.php/admin/portfolioslider/sil/'.$portfolio["Portfolio_Id"].'/'.$portfolio["Portfolio_slider_Id"];?>">
                                    ...
                                    <div class="card-footer bg-primary d-flex align-items-center justify-content-between">
                                        <a class="small text-white" href="<?php echo base_url().'index.php/admin/portfolioslider/ekle/'.$id;?>">Yeni Ekle</a>
