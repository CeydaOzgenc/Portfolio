                            ...
                            <div class="col-xl-12 col-md-6">
                                <div class="card text-white mb-4">
                                    ...
                                    <div class="card-body">
                                        <table id="datatablesSimple1">
                                            ...
                                            <?php foreach ($youtubes as $youtube){ ?>
                                                <tr>
                                                    <td><?php echo $youtube['Youtube_Chanel_Name'];?></td>
                                                    <td><?php echo $youtube['Youtube_Chanel_Key'];?></td>
                                                    <td>
                                                        <a href="<?php echo base_url().'index.php/admin/youtube/duzenle/'.$youtube["Youtube_Id"]?>">
                                                            <input class="btn btn-primary" type="submit" value="Düzenle">
                                                        </a>
                                                        <a href="<?php echo base_url().'index.php/admin/youtube/sil/'.$youtube["Youtube_Id"]?>">
                                    ...
                                    <div class="card-footer bg-primary d-flex align-items-center justify-content-between">
                                        <a class="small text-white" href="<?php echo base_url().'index.php/admin/youtube/ekle';?>">Yeni Ekle</a>
